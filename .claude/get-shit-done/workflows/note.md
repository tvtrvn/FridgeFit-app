...
- **Global scope**: `/Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/notes/`)
...
2. Glob `/Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/notes/` — works in any directory
