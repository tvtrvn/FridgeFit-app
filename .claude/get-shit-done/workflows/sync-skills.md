...
INSTALL_JS_GLOBAL="/Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
