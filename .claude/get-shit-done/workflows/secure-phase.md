...
```
Agent(
  prompt="Read /Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/get-shit-done/templates/SECURITY.md`
