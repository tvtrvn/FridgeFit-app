...
```bash
INIT=$(node "/Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/thinh/Desktop/WORKSPACE/FridgeFit-app/.claude/get-shit-done/templates/spec.md.
